...
`stale_insufficient_info` and `mostly_implemented_on_main` are never applied to
young items; apply requires those reports to be at least 60 days old unless a
manual run explicitly changes the threshold.
